...
import jp.developer.bbee.assemblepc.shared.common.tokyoTz
...
data class Composition(
    ...
    fun isReviewExpired(current: Instant): Boolean = if (reviewTime == null) {
        true
    } else {
        // レビューから１週間経過、または構成に変更があった場合、再レビュー可能
        val nextWeek = reviewTime.plus(1, DateTimeUnit.WEEK, tokyoTz)
        current >= nextWeek || updatedAt > reviewTime
    }
